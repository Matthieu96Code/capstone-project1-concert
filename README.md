...
# 📖 [Togoville Jazz Web page] <a name="about-project"></a>


**Togoville Jazz web page** is my Capstone project for the first module at microverse
...
In order to run this project you need: a web-browser on a computer
...
Feel free to check the [issues page](https://github.com/Matthieu96Code/capstone-project1-concert/issues/).
...
I would like to thank [Cindy Shin](https://www.behance.net/adagio07) for this beatiful design and [microverse](https://www.microverse.org/) for this opportunity
